...
function calender()
{
    ...
    const name_Days = ["Sun", "Mon", "Tue", "Wed", "Thurs", "Fri", "Sat"];
    ...
    const nameofdays=document.querySelector(".calender-weekDays");
    let nod = " ";
    for(var j=0; j<=6; j++)
    {
    ...
    const displayDays = document.querySelector(".calender-monthDays");
